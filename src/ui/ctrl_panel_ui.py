...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_angle.setText(_translate("Form", "          "))
        self.label_1.setText(_translate("Form", "占空比："))
        self.label_duty_cycle.setText(_translate("Form", "          "))
        self.label_4.setText(_translate("Form", "逆变温度："))
        self.label_temperature.setText(_translate("Form", "                                             "))
        self.label_3.setText(_translate("Form", "电机温度："))
        self.label_motor_temp.setText(_translate("Form", "          "))
        self.label_sys_status_2.setText(_translate("Form", "系统状态："))
        self.label_sys_status.setText(_translate("Form", "                 "))
