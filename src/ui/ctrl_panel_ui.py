...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.label_vbus_in, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_vdc, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_ud, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_ibus, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_uq, 2, 0, 1, 1)
        ...
        self.label_ia.setProperty("lightColor", QtGui.QColor(255, 5, 30))
        self.label_ia.setObjectName("label_ia")
        self.gridLayout.addWidget(self.label_ia, 2, 1, 1, 1)
        ...
        self.label_ib.setProperty("lightColor", QtGui.QColor(255, 5, 30))
        self.label_ib.setObjectName("label_ib")
        self.gridLayout.addWidget(self.label_ib, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_iq, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_ic, 4, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_angle, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_duty_cycle, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_dev_error, 4, 0, 1, 1)
        ...
        self.label_motor_temp = SubtitleLabel(self.CardWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_2.addWidget(self.label_motor_temp, 6, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_sys_status, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_fault_status, 8, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_fault_code, 9, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_vbus_in.setText(_translate("Form", "Vbus_in:"))
        ...
        self.label_ibus.setText(_translate("Form", "Ibus:"))
        self.label_uq.setText(_translate("Form", "Uq:"))
        self.label_ia.setText(_translate("Form", "Ia:"))
        self.label_id.setText(_translate("Form", "Id:"))
        self.label_ib.setText(_translate("Form", "Ib:"))
        self.label_iq.setText(_translate("Form", "Iq:"))
        self.label_ic.setText(_translate("Form", "Ic:"))
        self.label_speed.setText(_translate("Form", "转速："))
        self.btn_speed_set.setText(_translate("Form", "设置"))
        ...
        self.label_temperature.setText(_translate("Form", "逆变温度："))
        self.label_motor_temp.setText(_translate("Form", "电机温度："))
...
from qfluentwidgets import CardWidget, DoubleSpinBox, IconInfoBadge, LargeTitleLabel, PillPushButton, PushButton, RadioButton, SubtitleLabel
