...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_3.addWidget(self.LargeTitleLabel, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.SubtitleLabel_2, 1, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinbox_vbus_ref1, 4, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_speed_9, 10, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_speed_8, 9, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_start_resolver_calibration, 11, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinbox_speed_pid_i, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinbox_id_pid_i, 2, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_vbus_ref1, 4, 5, 1, 1)
        ...
        self.spinbox_Motor_Resolver_Zero.setMaximum(50.0)
        ...
        self.gridLayout_2.addWidget(self.label_speed_3, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_speed_pid_i, 1, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_iq_pid_i, 3, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_id_pid_i, 2, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_save_param, 12, 4, 1, 1)
        ...
        self.spinbox_Rottx_Zero_Current.setMaximum(50.0)
        ...
        self.gridLayout_2.addWidget(self.spinbox_iq_pid_i, 3, 4, 1, 1)
        self.btn_upgrade_mode_select = PillPushButton(self.CardWidget_2)
        self.btn_upgrade_mode_select.setMinimumSize(QtCore.QSize(0, 44))
        self.btn_upgrade_mode_select.setCheckable(True)
        self.btn_upgrade_mode_select.setObjectName("btn_upgrade_mode_select")
        self.gridLayout_2.addWidget(self.btn_upgrade_mode_select, 10, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_ctrl_mode_select, 9, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_speed_ctrl_mode_select, 9, 1, 1, 2)
        self.label_upgrade_mode_select = SubtitleLabel(self.CardWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_upgrade_mode_select.sizePolicy().hasHeightForWidth())
        self.label_upgrade_mode_select.setSizePolicy(sizePolicy)
        self.label_upgrade_mode_select.setMinimumSize(QtCore.QSize(0, 0))
        self.label_upgrade_mode_select.setTextFormat(QtCore.Qt.MarkdownText)
        self.label_upgrade_mode_select.setObjectName("label_upgrade_mode_select")
        self.gridLayout_2.addWidget(self.label_upgrade_mode_select, 10, 1, 1, 2)
        self.gridLayout_3.addWidget(self.CardWidget_2, 2, 1, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_upgrade_mode_select.setText(_translate("Form", "切换升级模式命令"))
        ...
        self.label_upgrade_mode_select.setText(_translate("Form", "当前未启动升级模式"))
from qfluentwidgets import CardWidget, DoubleSpinBox, LargeTitleLabel, PillPushButton, SubtitleLabel, TableWidget, ToolButton
