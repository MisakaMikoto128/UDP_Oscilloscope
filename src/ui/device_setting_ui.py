...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.list_pid_param = ListWidget(self.CardWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.list_pid_param.sizePolicy().hasHeightForWidth())
        self.list_pid_param.setSizePolicy(sizePolicy)
        self.list_pid_param.setObjectName("list_pid_param")
        self.gridLayout.addWidget(self.list_pid_param, 1, 0, 1, 1)
        ...
        self.spinbox_speed_pid_p = CompactDoubleSpinBox(self.CardWidget_2)
        ...
        self.spinbox_speed_pid_i = CompactDoubleSpinBox(self.CardWidget_2)
        ...
        self.spinbox_id_pid_p = CompactDoubleSpinBox(self.CardWidget_2)
        ...
        self.spinbox_id_pid_i = CompactDoubleSpinBox(self.CardWidget_2)
        ...
        self.spinbox_iq_pid_p = CompactDoubleSpinBox(self.CardWidget_2)
        ...
        self.spinbox_iq_pid_i = CompactDoubleSpinBox(self.CardWidget_2)
        ...
        self.spinbox_vbus_ref = CompactDoubleSpinBox(self.CardWidget_2)
        ...
        self.spinbox_vbus_ref1 = CompactDoubleSpinBox(self.CardWidget_2)
        ...
        self.gridLayout_2.addWidget(self.label_speed_10, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sw_btn_ctrl_mode_select, 5, 2, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.label_speed_11, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sw_btn_ctrl_mode_select_2, 6, 2, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.label_speed_13, 7, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_start_resolver_calibration, 7, 2, 1, 2)
...
from qfluentwidgets import CardWidget, CompactDoubleSpinBox, LargeTitleLabel, ListWidget, PillPushButton, SubtitleLabel, SwitchButton, ToolButton
