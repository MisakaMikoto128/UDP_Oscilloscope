...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.test_btn = HyperlinkButton(self.CardWidget)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 210, 206))
...
from qfluentwidgets import CaptionLabel, CardWidget, DoubleSpinBox, HyperlinkButton, PushButton, RadioButton, ScrollArea, SwitchButton
