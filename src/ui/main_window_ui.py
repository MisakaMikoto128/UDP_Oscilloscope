...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 146, 227))
    ...
    def retranslateUi(self, Form):
        ...
        self.SwitchButton.setText(_translate("Form", "实时波形显示模式"))
        self.SwitchButton.setOnText(_translate("Form", "实时波形显示模式"))
        self.SwitchButton.setOffText(_translate("Form", "实时波形显示模式"))
